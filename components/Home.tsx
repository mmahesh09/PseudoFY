...
const projects = [
  {
    title: "Language-Agnostic Support",
    description:
      "We support multiple programming languages—no matter what you're coding in, we've got you covered.",
    link: "https://stripe.com",
  },
  {
    title: "Readable & Clean Pseudocode",
    description:
      "Our AI generates pseudocode which is easy to understand, making complex logic simple and intuitive.",
    link: "https://netflix.com",
  },
  {
    title: "Perfect for Learning & Teaching",
    description:
      "Students and educators love using our tool to break down code and explain algorithms.",
    ...
    <div className="z-10 flex flex-col items-center justify-center min-h-screen px-4">
      <main className="pt-24 flex flex-col items-center justify-center text-center w-full max-w-5xl">
        ...
        <a
          ...
          className={cn(
            "group rounded-full border border-black/5 bg-neutral-100 text-base text-black transition-all ease-in hover:cursor-pointer hover:bg-neutral-200 dark:border-white/5 dark:bg-neutral-900 dark:text-white dark:hover:bg-neutral-800 mb-6"
          )}
        >
